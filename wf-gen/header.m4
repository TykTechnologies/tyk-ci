...
define(<<xUPGRADE_FROM>>, ifelse(xREPO, <<tyk>>, <<3.0.8>>, xREPO, <<tyk-analytics>>, <<3.0.9>>, xREPO, <<tyk-pump>>, <<1.4.0>>, xREPO, <<tyk-identity-broker>>, <<1.1.0>>, xREPO, <<tyk-sink>>, <<1.7.7>>, xREPO, <<raava>>, <<0.0.0>>))dnl
