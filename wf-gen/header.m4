...
define(<<xDH_REPO>>, <<ifelse(xREPO, <<tyk-pump>>, <<tyk-pump-docker-pub>>, xREPO, <<tyk-sink>>, <<tyk-mdcb-docker>>, xREPO, <<portal>>, <<developer-portal>>, xCOMPATIBILITY_NAME)>>)dnl
define(<<xPC_REPO>>, <<ifelse(xREPO, <<tyk-sink>>, <<tyk-mdcb>>, xCOMPATIBILITY_NAME)>>)dnl
define(<<xPC_PRIVATE>>, ifelse(xREPO, <<tyk-sink>>, <<1>>, <<0>>))dnl
define(<<xCGO>>, ifelse(xREPO, <<tyk>>, <<1>>, xREPO, <<tyk-analytics>>, <<1>>, xREPO, <<portal>>, <<1>>, <<0>>))dnl
...
define(<<xUPGRADE_FROM>>, ifelse(xREPO, <<tyk>>, <<3.0.8>>, xREPO, <<tyk-analytics>>, <<3.0.9>>, xREPO, <<tyk-pump>>, <<1.4.0>>, xREPO, <<tyk-identity-broker>>, <<1.1.0>>, xREPO, <<tyk-sink>>, <<1.7.7>>, xREPO, <<portal>>, <<0.0.0>>))dnl
