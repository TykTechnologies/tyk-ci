...
define(<<xUPGRADE_FROM>>, ifelse(xREPO, <<tyk>>, <<3.0.9~rc1>>, xREPO, <<tyk-analytics>>, <<3.0.4>>, xREPO, <<tyk-pump>>, <<1.2.0>>, xREPO, <<tyk-identity-broker>>, <<1.1.0>>, xREPO, <<tyk-sink>>, <<1.7.7>>, xREPO, <<raava>>, <<0.0.0>>))dnl
